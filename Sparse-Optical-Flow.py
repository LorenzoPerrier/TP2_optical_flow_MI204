...
cap = cv2.VideoCapture(r"C:\Users\loren\OneDrive - ENSTA Paris\ENSTA\2A\MI204\TP2\TP2_Videos\Extrait1-Cosmos_Laundromat1(340p).m4v")
...
while(ret):
    ...
    for i,(new,old) in enumerate(zip(good_new,good_old)):
        ...
        frame = cv2.circle(frame,(int(c),int(d)),3,(255,255,0),-1)
